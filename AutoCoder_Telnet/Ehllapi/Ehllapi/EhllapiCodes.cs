...
namespace AutoCoder.Ehllapi
{
  public partial class Ehllapier
  {
    ...
    {
      public const UInt32 CopyPresentationSpace = 5;
      public const UInt32 QueryCursorLocation = 7;
      public const UInt32 SetSessionParameters = 9;
      public const UInt32 QueryFieldAttribute = 14;
      public const UInt32 QuerySessionStatus = 22;
      public const UInt32 CopyFieldToString = 34;
      public const UInt32 ConvertPosition = 99;

      public const UInt32 CONNECT_PS = 1; /* 000 Connect PS*/
      public const UInt32 DISCONNECT_PS = 2; /* 000 Disconnect PS*/
      ...
      public const UInt32 Copy_OIA = 13; /* 000 Copy OIA function*/
