...
namespace AutoCoder.Network.Mail.OutMail
{
	...
	public class MailMessage
	{
		...
		string		mSubject ; 
		public string		mEncodedSubject = null ;
		public string		mEncodedFromAddress = null ;
		...
		// -------------------------------- Save --------------------------------
		public void Save( string InToPath )
		{
			StreamWriter sw = System.IO.File.CreateText( InToPath ) ;
			sw.Write( ToString( )) ;
			sw.Close( ) ;
		}
