...
namespace AutoCoder.Systm
{
  ...
  public class InputByteArray
  {
    ...
    public byte[] DataBytes
    {
      get
      {
        return this.Bytes.SubArray(0, this.DataLgth);
      }
    }
    ...
    public override string ToString()
    {
      ...
      sb.Append("Length:" + this.DataLgth);
      sb.Append(" Remaining lgth:" + this.RemainingLength);
      sb.Append(" Bytes:" + this.PeekBytesLenient(16).ToHex(' '));
      return sb.ToString();
    }
  }
}
