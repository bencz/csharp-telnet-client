...
namespace AutoCoder.Text
{
    ...
    // If any text preceeds the found delim pattern, the next work method returns that text as the
    // word and the delim pattern as the delim.
    ...
    {
      mWhitespacePatterns.CollectionChanged += 
        new NotifyCollectionChangedEventHandler(mWhitespacePatterns_CollectionChanged);





      mWhitespacePatterns.ScanPatternsChanged +=
        new delScanPatternsChanged(WhitespacePatterns_ScanPatternsChanged);
      mNewLinePatterns.ScanPatternsChanged +=
        new delScanPatternsChanged(WhitespacePatterns_ScanPatternsChanged);
      mDividerPatterns.ScanPatternsChanged +=
        new delScanPatternsChanged(WhitespacePatterns_ScanPatternsChanged);
      mCommentToEndPatterns.ScanPatternsChanged +=
        new delScanPatternsChanged(WhitespacePatterns_ScanPatternsChanged);
      mQuotePatterns.ScanPatternsChanged +=
        new delScanPatternsChanged(WhitespacePatterns_ScanPatternsChanged);
      mExpressionPatterns.ScanPatternsChanged +=
        new delScanPatternsChanged(WhitespacePatterns_ScanPatternsChanged);
      mEndStmtPatterns.ScanPatternsChanged +=
        new delScanPatternsChanged(WhitespacePatterns_ScanPatternsChanged);
      mOpenNamedBracedPatterns.ScanPatternsChanged +=
        new delScanPatternsChanged(WhitespacePatterns_ScanPatternsChanged);
      mOpenContentBracedPatterns.ScanPatternsChanged +=
        new delScanPatternsChanged(WhitespacePatterns_ScanPatternsChanged);
      mPathSepPatterns.ScanPatternsChanged +=
        new delScanPatternsChanged(WhitespacePatterns_ScanPatternsChanged);
    }

    void mWhitespacePatterns_CollectionChanged(
      object sender, NotifyCollectionChangedEventArgs e)
    {
      _NewLineIsWhitespace = null;
    }
