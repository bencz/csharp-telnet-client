...
{
  /// <summary>
  /// Class used to traverse the registry to read all the file previewer registrations
  /// that exist on the system
  /// </summary>
  public class RegistryAccess
  {
    private const string BaseRegistryKey = 
      "SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\PreviewHandlers";
    private const string BaseClsIDKey = 
@"HKEY_CLASSES_ROOT\{0}\shellex\{{8895b1c6-b41f-4c1c-a562-0d564250836f}}";
    private const string BaseClsIdKey2 = 
@"HKEY_CLASSES_ROOT\SystemFileAssociations\{0}\shellex\{{8895b1c6-b41f-4c1c-a562-0d564250836f}}";
    ...
    internal static RegistrationData LoadRegistrationInformation()
    {
      ...
      handlers.Sort(
        delegate(PreviewHandlerInfo first, PreviewHandlerInfo second)
        {
      ...
      Dictionary<string, PreviewHandlerInfo> handlerMapping = 
        new Dictionary<string, PreviewHandlerInfo>(handlers.Count);
